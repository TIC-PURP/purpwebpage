...
const valores = ["Trust", "Responsibility", "Innovation", "integrity", "quality"];
              ...
              <Grid item xs={12} md={7}>
                <Stack spacing={3}>
                  ...
                  <TextSection variant="body1">
                    ...
                    professionalism and certified quality, contributing to the economic development
                    of the region.
                  </TextSection>

                  <Heading id="proposito">PURPOSE</Heading>
                  <TextSection variant="body1">
